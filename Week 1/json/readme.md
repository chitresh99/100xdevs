JSON is used to represent structured data in a text format. It's commonly used to transmit data between a server and a web application as well as to store and exchange data.
